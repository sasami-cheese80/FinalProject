...
extension CLLocationCoordinate2D {
    ...
    static let toyotaStation = CLLocationCoordinate2D(latitude: 35.08799265528111, longitude: 137.15624391882318)
    
    static let myHome = CLLocationCoordinate2D(latitude: 35.082701425451276, longitude:137.15605823898323)
